...
#define         FRAM_GYRO_ACCELERATION_PARAM_ADDR   300//急加速阈值,4字节,分别对应4段速度0~30,30~60,60~90,90~
#define         FRAM_GYRO_ACCELERATION_PARAM_LEN    4
#define         FRAM_GYRO_DECELERATION_PARAM_ADDR   305//急减速阈值,2字节,分别对应两段速度0~30,30~
#define         FRAM_GYRO_DECELERATION_PARAM_LEN    2
...
#define FRAM_STOP_15MINUTE_SPEED_ADDR                   1296//停车前16分钟速度
#define FRAM_STOP_15MINUTE_SPEED_LEN                    48  //(2byte + 1byte = 时分 + 速度)*16
 
#define FRAM_STOP_15MIN_TIME_ADDR                       1345//停车前15分速度停驶时间(1min侦测
#define FRAM_STOP_15MIN_TIME_LEN                        6   //6byte BCD
 
#define FRAM_STOP_DOUBT_TIME_ADDR                       1352//事故疑点停驶时间(200ms侦测
#define FRAM_STOP_DOUBT_TIME_LEN                        6   //6byte BCD
...
#define	FRAM_MILEAGE_BACKUP_ADDR			1505	//总里程备份存储地址,带校验字节,
#define	FRAM_MILEAGE_BACKUP_LEN			        4	//总里程备份存储长度,带校验字节

#define FRAM_INTERFACE_SWOTCH_ADDR                       1510
#define FRAM_INTERFACE_SWOTCH_LEN                        2

#define FRAM_TURNSPEED_PULSE_NUM_ADDR                   1513//转速脉冲个数
