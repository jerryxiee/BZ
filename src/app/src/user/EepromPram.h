...
#define	E2_SYSTEM_DEFINE_ID_MAX			(E2_CAN_SET_ONLY_GATHER_1_ID+1)//系统定义的最大ID为最后的ID加1,注意：每次新增参数时需要将最后的参数ID放在这
///////////////////////////////////////////////////////
...
#define E2_ENGINE_NUM_ID       				 E2_PRAM_BASE_CUSTOM_ID+0x9D//参数ID，自定义，发动机号码，最大20个字节
...
#define E2_DEEP_SENSORMIN_ID_ADDR                    (EEPROM_PRAM_BASE_ADDR+2772)//3
//参数ID，自定义，传感器的最小值
#define E2_DEEP_SENSORMIN_LENGTH_ID_ADDR                   (EEPROM_PRAM_BASE_ADDR+2775)//3
//参数ID，自定义，传感器最小值对应的耕深，单位厘米
#define E2_DEEP_BASE_HEIGHT_ID_ADDR                  (EEPROM_PRAM_BASE_ADDR+2778)//3
//参数ID，自定义，耕深基准值，单位厘米
#define E2_DEEP_ARM_LENGTH_ID_ADDR                   (EEPROM_PRAM_BASE_ADDR+2781)//3
//参数ID，自定义，基准臂长，单位厘米
#define E2_DEEP_MAX_LENGTH_ID_ADDR                   (EEPROM_PRAM_BASE_ADDR+2784)//3
//参数ID，自定义，基准高度，单位厘米
#define E2_DEEP_SENSORMAX_ID_ADDR                    (EEPROM_PRAM_BASE_ADDR+2787)//3
//参数ID，自定义，传感器的最大值
#define E2_DEEP_SENSORMAX_LENGTH_ID_ADDR             (EEPROM_PRAM_BASE_ADDR+2791)//3
//参数ID，自定义，传感器最大值对应的耕深，单位厘米

#define E2_ENGINE_NUM_ID_ADDR               (EEPROM_PRAM_BASE_ADDR+2769)//16
//参数ID，自定义，发动机号码，最大20个字节
...
#define E2_DEEP_SENSORMIN_ID_LEN                    2//3
//参数ID，自定义，传感器的最小值
#define E2_DEEP_SENSORMIN_LENGTH_ID_LEN                   2//3
//参数ID，自定义，传感器最小值对应的耕深，单位厘米
#define E2_DEEP_BASE_HEIGHT_ID_LEN                  2//3
//参数ID，自定义，耕深基准值，单位厘米
#define E2_DEEP_ARM_LENGTH_ID_LEN                   2//3
//参数ID，自定义，基准臂长，单位厘米
#define E2_DEEP_MAX_LENGTH_ID_LEN                   2//3
//参数ID，自定义，基准高度，单位厘米
#define E2_DEEP_SENSORMAX_ID_LEN                    2//3
//参数ID，自定义，传感器的最大值
#define E2_DEEP_SENSORMAX_LENGTH_ID_LEN             2//3
//参数ID，自定义，传感器最大值对应的耕深，单位厘米

//参数ID，自定义，发动机号码，最大16个字节
#define E2_ENGINE_NUM_ID_LEN            16
