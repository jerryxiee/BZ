...
#define PRINT_SPEED_OK 1//如果定义了，则打印“速度状态：正常”，不会出现异常的情况

#define	FIRMWARE_VERSION	 "11109"//特别注意从V1.01.09版本开始固件升级有分支校验,此处设置需与main.c中的固件版本相一致,main.c中的后5位与Ver:xxxxx项同
...
#define FIRMWARE_TIME		 "201801101541"//编译时间
