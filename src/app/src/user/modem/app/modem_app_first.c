...
void Net_First_Login(Modem_APP_STATE state)
{
    ...
    if(1 == MultiCenterConnect_GetRequestFlag())   //检测多中心连接标志
    {
...
void Net_First_Init(void)
{
    ...
    if((NetFirst_HeartVal > (MODEM_TMIN*5))||(NetFirst_HeartVal < (30*MODEM_TSEC)))//dxl,2015.4.21,增加最小值限制,防止心跳包参数设置错误的情况
    {
