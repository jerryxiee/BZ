...
void Vdr_Usb_Package(u8 cmdnum)
{
    ...
    ////////////////////////////////////////////////////////////////////////显示
    LcdShowCaption((char *)Usb_Data_Name[cmdnum], 20);
    ...
    //////////////////////////////////////////////////////////////////////初始化
    LcdShowCaption("正在计算总包数...", 38);
    Vdr_Get_PackageInf(packageinf,&packageser);
    
    ////////////////////////////////////////////////////////////////////////名称
    flensl = Vdr_Usb_BlkNm(cmdnum);
    LcdClearArea(0, 38, 131, 56);
    sprintf(display,"总:%-4d",packageser.all);
    LcdShowStr(0, 38,display, 0);
    ////////////////////////////////////////////////////////////////////////数据
    if(packageser.cnt < packageser.all)
    {
        for(;;)
        {
            sprintf(display,"Cnt=%-4d",packageser.cnt);
            LcdShowStr(66, 38,display, 0);
