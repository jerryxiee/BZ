...
//                    øÐÍEGS701-1\STM32F2xx_Boot_V1.62\STM32F2xx_Boot_130815_ /
//                    IAR6.1\STM32_Boot\STM32F2xx_StdPeriph_Driver\src\stm32f /
//                    2xx_cryp_tdes.c -D STM32F10X_CL -D                      /
...
//                    øÐÍEGS701-1\STM32F2xx_Boot_V1.62\STM32F2xx_Boot_130815_ /
//                    IAR6.1\STM32_Boot\EWARM\Debug\List\stm32f2xx_cryp_tdes. /
//                    s                                                       /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////

        NAME stm32f2xx_cryp_tdes
        ...
        PUBLIC CRYP_TDES_CBC
        PUBLIC CRYP_TDES_ECB
...
??CRYP_TDES_ECB_2:
        CMP      R9,R4
        BCS.N    ??CRYP_TDES_ECB_3
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
        CMP      R7,#+0
        BEQ.N    ??CRYP_TDES_ECB_3
        LDR      R0,[R11, #+0]
        BL       CRYP_DataIn
        ADDS     R11,R11,#+4
        LDR      R0,[R11, #+0]
...
??CRYP_TDES_ECB_4:
        ...
        LDR      R0,[SP, #+0]
        CMP      R0,#+65536
        BEQ.N    ??CRYP_TDES_ECB_5
        CMP      R6,#+0
        BNE.N    ??CRYP_TDES_ECB_4
??CRYP_TDES_ECB_5:
        CMP      R6,#+0
        BEQ.N    ??CRYP_TDES_ECB_6
        MOVS     R0,#+0
        MOVS     R7,R0
        B.N      ??CRYP_TDES_ECB_7
??CRYP_TDES_ECB_6:
...
??CRYP_TDES_CBC_2:
        CMP      R8,R4
        BCS.N    ??CRYP_TDES_CBC_3
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+0
        BEQ.N    ??CRYP_TDES_CBC_3
        LDR      R0,[R11, #+0]
        BL       CRYP_DataIn
        ADDS     R11,R11,#+4
        LDR      R0,[R11, #+0]
...
??CRYP_TDES_CBC_4:
        ...
        LDR      R0,[SP, #+0]
        CMP      R0,#+65536
        BEQ.N    ??CRYP_TDES_CBC_5
        CMP      R5,#+0
        BNE.N    ??CRYP_TDES_CBC_4
??CRYP_TDES_CBC_5:
        CMP      R5,#+0
        BEQ.N    ??CRYP_TDES_CBC_6
        MOVS     R0,#+0
        MOVS     R6,R0
        B.N      ??CRYP_TDES_CBC_7
??CRYP_TDES_CBC_6:
