...
#define sFLASH_AT26DF161_ID       0x1F4700
...
#define SPI_INTERFACE_INIT()                 sFLASH_LowLevel_Init()        //SPI读写函数前都需要调用该初始化函数,这是由于和EEPROM工口导致.
   
/* Exported macro ------------------------------------------------------------*/
/* Select sFLASH: Chip Select pin low */
#define sFLASH_CS_LOW()       GPIO_ResetBits(sFLASH_CS_GPIO_PORT, sFLASH_CS_PIN);spi_Delay_uS(20)
/* Deselect sFLASH: Chip Select pin high */
#define sFLASH_CS_HIGH()      GPIO_SetBits(sFLASH_CS_GPIO_PORT, sFLASH_CS_PIN);spi_Delay_uS(20)   
